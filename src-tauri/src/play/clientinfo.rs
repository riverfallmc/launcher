...
impl ClientInfo {
    ...
    pub fn get_folder(&self, base_dir: &str) -> anyhow::Result<PathBuf> {
    ...
    pub fn get_jar(&self, base_dir: &str) -> anyhow::Result<PathBuf> {
        let path = self
            .get_folder(base_dir)?
    ...
    pub fn get_data(&self, base_dir: &str) -> anyhow::Result<PathBuf> {
        let path = self
            .get_folder(base_dir)?
    ...
    pub fn open_data(&self, base_dir: &str) -> anyhow::Result<VersionData> {
...
pub(crate) fn get_client_info(path: &str) -> anyhow::Result<ClientInfo> {
