...
///@ts-ignore мне лень добавлять какой-то ебаный .d.ts чёта там сука писать пошло оно нахуй крч)) TODO
    ...
    <Window onClose={onClose}>
      <div className="flex flex-col gap-y-8">
        <div className="flex gap-x-3">
          <Pixelfall onClick={() => playSound("/sounds/fart.mp3")} className="aspect-square cursor-pointer w-16"/>
